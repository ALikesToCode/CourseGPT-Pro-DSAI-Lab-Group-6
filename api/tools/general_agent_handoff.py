...
@tool
def general_agent_handoff(task_summary: str, thinking_outline: list[str], route_plan: list[str], route_rationale: str, handoff_plan: str, todo_list: list[str], acceptance_criteria: list[str], expected_artifacts: list[str], difficulty: str, tags: list[str], metrics: dict, compute_budget: dict, repro: dict, citation_policy: str, io_schema: dict, requires_browse: bool):
    """
    ...
    Args:
        ...
        handoff_plan: Specific instructions for the general agent.
    ...
    """
    return f"Handoff to General Agent initiated.\nPlan: {handoff_plan}\nContext: {route_rationale}"
