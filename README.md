...
- [CourseGPT: DSAI Project Report (Team 6)](#coursegpt-dsai-project-report-team-6)
  ...
  - [4. Dataset and Methodology (Milestones 2–3)](#4-dataset-and-methodology-milestones-23)
    ...
    - [4.2. Agentic Workflow Design (The Methodology)](#42-agentic-workflow-design-the-methodology)
      - [4.2.1. The Logic Core: Understanding the Conditional Edge (Routing Logic)](#421-the-logic-core-understanding-the-conditional-edge-routing-logic)
      - [4.2.2. Intent Classification](#422-intent-classification)
      - [4.2.3. Inter-Agent Communication: State Management](#423-inter-agent-communication-state-management)
