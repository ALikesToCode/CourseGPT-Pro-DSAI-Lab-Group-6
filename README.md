<div align="center">
  <br><br><br>
  <p><strong style="font-size:28px;">CourseGPT: A LangGraph-Based Student Helper Chatbot</strong></p>
  ...
  <p style="font-size:16px; margin:10px 0 8px 0;">Submitted by:</p>
  ...
  <p style="font-size:15px; margin:8px 0 0 0;">Indian Institute of Technology Madras</p>
  <br><br><br>
</div>
