...
- Zhao et al. — taxonomy of RAG architectures and coordination trade-offs (Ref. [1](https://arxiv.org/html/2506.00054v1)).
- Gao et al. — survey of augmentation methods, benchmarks, and open problems (Ref. [2](https://arxiv.org/abs/2402.19473)).
- NVIDIA NIM tutorial — enterprise-grade multimodal ingestion and reranking workflow (Ref. [5](https://developer.nvidia.com/blog/build-an-enterprise-scale-multimodal-document-retrieval-pipeline-with-nvidia-nim-agent-blueprint/)).
- LayoutLMv3 documentation — joint text/layout/vision pre-training for document AI (Refs. [12](https://arxiv.org/pdf/2204.08387.pdf), [13](https://thirdeyedata.ai/ocr-and-layoutlmv3/), [14](https://nanonets.com/blog/layoutlm-explained/)).
- Donut by Kim et al. — OCR-free parsing for multilingual documents (Refs. [15](https://arxiv.org/abs/2111.15664), [17](https://github.com/clovaai/donut)).
- Toolformer framework — self-supervised API acquisition for LLMs (Refs. [24](https://arxiv.org/pdf/2302.04761.pdf), [25](https://www.emergentmind.com/topics/toolformer), [26](https://towardsdatascience.com/toolformer-guiding-ai-models-to-use-external-tools-37e4227996f1/)).
- AGREE + G3 — grounding adaptations that raise citation precision (Refs. [45](https://research.google/blog/effective-large-language-model-adaptation-for-improved-grounding/), [46](https://arxiv.org/abs/2311.09533), [47](https://aclanthology.org/2024.naacl-long.346/), [48](https://aclanthology.org/2024.findings-acl.838.pdf), [49](https://openreview.net/pdf/62a444fe75ed2d4894cd5c7afc34e881a6f5a82d.pdf)).
- GSM8K, MathScale, and DotaMath — progressive math benchmarks for CourseGPT-Pro (Refs. [64](https://www.mdpi.com/2076-3417/15/15/8387), [68](https://arxiv.org/abs/2403.02884), [70](https://arxiv.org/abs/2407.04078)).
- LoRA, QLoRA, HydraLoRA — parameter-efficient adapters for multi-domain fine-tuning (Refs. [73](http://arxiv.org/pdf/2405.00732.pdf), [74](https://arxiv.org/pdf/2305.14314.pdf), [78](https://ieeexplore.ieee.org/document/10903789/)).
- DistilDP and frontier-to-open distillation — safe synthetic data generation (Refs. [82](https://aclanthology.org/2024.findings-acl.769.pdf), [83](https://arxiv.org/abs/2410.18588)).
- CoT and program-of-thought methods — reasoning improvements for math/code tasks (Refs. [90](https://invisibletech.ai/blog/how-to-teach-chain-of-thought-reasoning-to-your-llm), [94](https://arxiv.org/pdf/2309.11054.pdf), [96](https://arxiv.org/abs/2505.09970)).
- Router/orchestration literature — modular agent design and workflow tuning (Refs. [98](https://ijcionline.com/paper/13/13624ijci02.pdf), [102](https://arxiv.org/abs/2505.13516), [103](https://www.semanticscholar.org/paper/6805515d30840c94e0c2a232b1a7321b59032f1e), [104](https://arxiv.org/html/2509.07571v1), [105](https://arxiv.org/pdf/2410.21784.pdf)).
- Vector DB comparisons — guidance on Milvus, Qdrant, and FAISS trade-offs (Refs. [106](https://www.f22labs.com/blogs/qdrant-vs-milvus-which-vector-database-should-you-choose/), [109](https://zilliz.com/comparison/qdrant-vs-faiss)).
- RAG evaluation guides — metrics for faithfulness, retrieval, and response quality (Refs. [117](https://www.elastic.co/search-labs/blog/evaluating-rag-metrics), [119](https://kamalct.substack.com/p/beyond-bleu-the-limits-of-traditional)).
- Transformer + transfer learning primers — foundations for domain pre-training (Refs. [120](https://en.wikipedia.org/wiki/Transformer_(deep_learning_architecture)), [128](https://www.sapien.io/blog/fine-tuning-vs-pre-training-key-differences-for-language-models)).
- Educational deployments and benchmarks — scaffolding insights for CourseGPT-Pro (Refs. [135](https://today.ucsd.edu/story/this-bespoke-ai-tutor-helps-students-learning), [136](https://arxiv.org/html/2406.05600v1), [137](https://www.kaggle.com/datasets/open-benchmarks/mathvista)).
- Additional supporting citations (Refs. [7](https://weaviate.io/blog/hybrid-search-explained), [10](https://docs.pinecone.io/guides/search/hybrid-search), [11](https://www.usaii.org/ai-insights/multimodal-rag-explained-from-text-to-images-and-beyond), [65](https://github.com/openai/grade-school-math), [71](https://arxiv.org/abs/2409.02834), [72](http://arxiv.org/pdf/2405.07551.pdf), [79](http://arxiv.org/pdf/2404.19245.pdf), [80](https://arxiv.org/pdf/2402.16141.pdf), [81](https://arxiv.org/html/2410.01497), [87](https://www.redhat.com/en/blog/synthetic-data-secret-ingredient-better-language-models), [88](https://wandb.ai/byyoung3/ML_NEWS3/reports/Knowledge-distillation-Teaching-LLM-s-with-synthetic-data--Vmlldzo5MTMyMzA2), [89](https://neptune.ai/blog/knowledge-distillation), [91](https://www.nvidia.com/en-us/glossary/cot-prompting/), [95](https://arxiv.org/abs/2405.16265), [107](https://zilliz.com/comparison/milvus-vs-qdrant), [110](https://www.gpu-mart.com/blog/top-5-open-source-vector-databases-2024/), [111](https://www.datacamp.com/blog/the-top-5-vector-databases), [113](https://www.geeksforgeeks.org/nlp/understanding-bleu-and-rouge-score-for-nlp-evaluation/), [114](https://clementbm.github.io/theory/2021/12/23/rouge-bleu-scores.html), [118](https://www.adaline.ai/blog/understanding-bleu-rouge-and-modern-nlp-metrics), [130](https://arxiv.org/html/2408.06663v2), [134](https://www.geeksforgeeks.org/nlp/encoder-decoder-models/), [138](https://arxiv.org/abs/2310.02255), [140](https://huggingface.co/datasets/Reja1/jee-neet-benchmark)).
...
* **MathVista** — CC BY-SA 4.0 (evaluation, non-commercial) (Ref. [141](https://huggingface.co/datasets/AI4Math/MathVista)).
* **DAPO-Math-17k** — Apache-2.0 (permissive, OSI-approved) (Ref. [142](https://huggingface.co/datasets/BytedTsinghua-SIA/DAPO-Math-17k)).
* **MathX-5M** — MIT (permissive, OSI-approved) (Ref. [143](https://huggingface.co/datasets/XenArcAI/MathX-5M)).
* **ScienceQA** — CC BY-SA 4.0 (evaluation, non-commercial) (Ref. [144](https://huggingface.co/datasets/armanc/ScienceQA)).
* **JEE-NEET Benchmark** — MIT (permissive, OSI-approved) (Ref. [145](https://huggingface.co/datasets/Reja1/jee-neet-benchmark)).
* **JEEBench** — MIT (permissive, OSI-approved) (Ref. [146](https://huggingface.co/datasets/daman1209arora/jeebench)).
